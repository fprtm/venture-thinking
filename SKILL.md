...
1. **FRAME** — Force the problem into focus before any solution. Answer, out loud, for their idea: *who exactly*, *what problem*, *why it happens*, *how often*, *how painful*, *what they use today*, *will they pay*. Vague answers here are the finding — chase them down. Full battery: [`references/framing.md`](references/framing.md). **Done when:** the idea is stated as one falsifiable hypothesis sentence naming the customer, the pain, and the willingness-to-pay.
